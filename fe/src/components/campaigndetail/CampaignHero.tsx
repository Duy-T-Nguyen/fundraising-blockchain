          ...
          <div className="w-full lg:w-[45%] p-8 lg:pr-4">
            <div className="relative h-[300px] lg:h-full rounded-[2rem] overflow-hidden shadow-2xl group bg-gray-100">
              ...
              <img
                ...
                className={`w-full h-full object-cover group-hover:scale-105 transition-all duration-1000 ${imageLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-110'
                  }`}
              />
              <div className="absolute top-6 left-6 z-20">
                <span className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest shadow-lg ${active ? 'bg-white text-green-600' : 'bg-gray-400 text-white'
                  }`}>
