...
\midrule
1 & Nguyễn Thành Long & 022205011246 & Tham gia lập kế hoạch, tổng hợp tài liệu, theo dõi tiến độ và hoàn thiện báo cáo \\
2 & Đỗ Nguyễn Phương Thảo & 036305010922 & Tham gia phân tích nội dung, rà soát minh chứng và hoàn thiện báo cáo \\
...
\midrule
\endhead
Giảng viên/người nghiệm thu & Định hướng, phản hồi tại milestone và xác nhận sản phẩm môn học & Phê duyệt/chấp nhận deliverable cấp cao \\
Project Manager & Tích hợp kế hoạch, điều phối nguồn lực, theo dõi baseline, rủi ro và thay đổi & Project plan, status report, quyết định điều phối \\
Product Owner/BA & Thu thập, làm rõ, ưu tiên yêu cầu và duy trì RTM/backlog & Requirement baseline và acceptance intent \\
Technical Lead & Duy trì kiến trúc, interface, chuẩn kỹ thuật và review thay đổi có tác động rộng & Technical decision và integration gate \\
Blockchain Developer & Thực hiện và kiểm thử logic quản lý quỹ/quyền truy cập & Contract module, test và deployment support \\
Backend/AI Developer & Thực hiện API, dữ liệu, thông báo, relayer và sidecar & Backend services, API test và runbook \\
Frontend Developer & Thực hiện giao diện, wallet flow, dashboard và tích hợp & Frontend build, UI test và demo \\
QA/Tester & Lập test plan, thiết kế test, triage defect và cung cấp bằng chứng chất lượng & Test report, UAT checklist và quality recommendation \\
...
\midrule
\endhead
Project Charter & A & R & C & C & I & I & I & I \\
Scope/Requirement Baseline & C & A & R & C & C & C & C & C \\
Schedule/Cost Baseline & I & A/R & C & C & C & C & C & C \\
Kiến trúc/thiết kế tích hợp & I & C & C & A/R & R & R & R & C \\
Blockchain work package & I & I & C & A & R & C & C & C \\
Backend/AI work package & I & I & C & A & C & R & C & C \\
Frontend work package & I & I & C & A & C & C & R & C \\
Test plan và quality gate & I & C & C & C & C & C & C & A/R \\
Tích hợp end-to-end & I & C & C & A & R & R & R & R \\
Deploy/release & I & A & I & R & C & R & R & C \\
Change Request lớn & A & R & C & C & C & C & C & C \\
UAT/nghiệm thu & A & R & R & C & I & I & I & R \\
...
\midrule
Charter và governance & A/R & C & C \\
Stakeholder register và engagement & A & R & C \\
Requirement, Scope Statement và RTM & A & R & R \\
WBS, CPM và Schedule Baseline & A/R & C & R \\
Cost Baseline, EVM và NPV & A & C & R \\
Quality plan, test evidence và UAT & A & R & C \\
Risk, configuration và change log & A & C & R \\
Weekly status và tích hợp hồ sơ & A/R & C & C \\
Rà soát nhất quán và trích dẫn & A & R & R \\
...
\midrule
\endhead
Quản trị phạm vi/lịch/chi phí & 4 & 2 & 2 & 2 & 3 \\
Phân tích yêu cầu/acceptance & 4 & 3 & 3 & 3 & 4 \\
Thiết kế hệ thống/tích hợp & 2 & 4 & 3 & 3 & 3 \\
Smart contract/security & 1 & 4 & 2 & 1 & 3 \\
Backend/API/dữ liệu & 1 & 3 & 4 & 2 & 3 \\
Frontend/UI/UX & 2 & 2 & 2 & 4 & 3 \\
Kiểm thử/defect management & 2 & 3 & 3 & 3 & 4 \\
CI/CD/configuration & 2 & 3 & 3 & 3 & 3 \\
...
\midrule
1.0 Khởi tạo/quản trị & 72 & 7,5\% & PM, BA \\
2.0 Phân tích phạm vi & 96 & 10,0\% & PM, BA, QA, TL \\
3.0 Thiết kế & 96 & 10,0\% & TL, BA, FE/BE/BC \\
4.0 Blockchain & 144 & 15,0\% & BC, TL, QA \\
5.0 Backend/AI & 120 & 12,5\% & BE, TL, QA \\
6.0 Frontend & 120 & 12,5\% & FE, BA, QA \\
7.0 Tích hợp & 96 & 10,0\% & TL, BC, BE, FE, QA \\
8.0 Kiểm thử/chất lượng & 96 & 10,0\% & QA và toàn nhóm \\
9.0 Triển khai & 48 & 5,0\% & DevOps, TL, QA \\
...
\begin{tabularx}{\textwidth}{p{2.3cm}Xrrr r}
\toprule
\textbf{Thời gian} & \textbf{Trọng tâm công việc} & \textbf{Long} & \textbf{Thảo} & \textbf{Hà} & \textbf{Tổng} \\
\midrule
01/04--07/04 & Charter, stakeholder, governance & 8 & 8 & 6 & 22 \\
08/04--21/04 & Yêu cầu, phạm vi, WBS, RTM & 12 & 14 & 12 & 38 \\
22/04--05/05 & Thiết kế kế hoạch, CPM, quality approach & 10 & 10 & 12 & 32 \\
06/05--15/05 & Theo dõi milestone, cost và risk & 10 & 8 & 8 & 26 \\
16/05--26/05 & Status, change và evidence review & 10 & 8 & 8 & 26 \\
27/05--11/06 & Tích hợp hồ sơ, quality và consistency & 10 & 10 & 10 & 30 \\
12/06--25/06 & UAT, deployment record, nghiệm thu & 8 & 10 & 10 & 28 \\
...
\midrule
\endhead
01/04--07/04 & Khởi tạo & Nhóm 2 giữ PM/BA; TL/QA kỹ thuật tham vấn & Charter, stakeholder và governance \\
08/04--21/04 & Phạm vi & Nhóm 2 chủ đạo; đội kỹ thuật review yêu cầu & Scope Baseline, WBS và RTM \\
22/04--05/05 & Thiết kế & TL cùng BC/BE/FE; Nhóm 2 theo dõi và tổng hợp & Design baseline và test approach \\
06/05--26/05 & Ba nhánh phát triển & BC/BE/FE chạy song song; TL/QA kiểm soát interface & Ba increment sẵn sàng tích hợp \\
27/05--11/06 & Tích hợp và hoàn thiện & Đội kỹ thuật tích hợp; Nhóm 2 theo dõi rủi ro và thay đổi & E2E, regression và defect fixes \\
12/06--25/06 & Deploy/UAT & DevOps, QA, PM; Nhóm 2 phối hợp nghiệm thu & Release candidate, UAT và fixes \\
...
\midrule
Project onboarding & Hiểu Charter, scope, WBS và governance & Tuần 1 & Checklist hoàn thành \\
Workshop yêu cầu/WBS & Thống nhất requirement và work package & Tuần 2--3 & RTM/WBS review \\
Security/threat review & Nhận diện rủi ro tiền, quyền và secret & Tuần 4--5 & Threat checklist \\
Pair programming & Chuyển giao kiến thức module quan trọng & Tuần 6--10 & PR/review record \\
Test case workshop & Nâng chất lượng acceptance/negative test & Tuần 8--10 & Test case review \\
Deployment rehearsal & Giảm rủi ro release và key-person & Tuần 11 & Runbook/smoke test \\
Demo rehearsal & Đồng bộ câu chuyện sản phẩm và quản trị & Tuần 12--13 & Feedback/action list \\
...
\midrule
\endhead
Hoàn thành & Deliverable đúng hạn, effort còn lại và acceptance status & Dự báo tiến độ và hỗ trợ sớm \\
Chất lượng & Defect, rework, test pass và review finding & Cải thiện quy trình/năng lực \\
Hợp tác & Phản hồi review, chia sẻ tri thức và hỗ trợ blocker & Đánh giá đóng góp nhóm \\
Kỷ luật quản trị & Cập nhật task, báo cáo rủi ro và tuân thủ Change Control & Bảo vệ baseline \\
Học tập & Khoảng cách năng lực giảm và có backup person & Giảm key-person risk \\
...
\midrule
Collaborate & Vấn đề quan trọng, cần giải pháp bền vững & Ưu tiên mặc định; cần thời gian và dữ kiện \\
Compromise & Hai phía có quyền lợi hợp lý, thời gian hạn chế & Mỗi bên nhượng bộ; kiểm tra residual risk \\
Điều hòa & Vấn đề nhỏ, giữ quan hệ quan trọng hơn & Không dùng để che giấu vấn đề chất lượng \\
Force/Direct & Incident khẩn cấp hoặc quyết định thuộc thẩm quyền rõ & Ghi lý do và review sau khẩn cấp \\
