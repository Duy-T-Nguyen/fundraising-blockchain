...
\hline
Business logic và smart contract & Make & Là giá trị cốt lõi, cần kiểm soát trực tiếp \\ \hline
Frontend/backend integration & Make & Phản ánh nghiệp vụ và luồng người dùng của dự án \\ \hline
RPC provider & Buy & Dịch vụ hạ tầng chuẩn, tự vận hành không hiệu quả ở quy mô đề tài \\ \hline
IPFS pinning & Buy & Tối ưu thời gian và công sức vận hành lưu trữ \\ \hline
MongoDB/Redis/hosting & Buy & Tiện cho prototype và demo, dễ triển khai \\ \hline
...
\hline
Chi phí tổng sở hữu & Không chỉ giá niêm yết mà cả chi phí vận hành, nâng gói và di chuyển \\ \hline
Tính sẵn sàng/SLA & Mức ổn định cần thiết cho môi trường thử nghiệm và demo \\ \hline
Bảo mật & Cơ chế quản lý key, truy cập, backup và nhật ký \\ \hline
Khả năng mở rộng & Có đáp ứng được tăng tải ở mức hợp lý nếu cần mở rộng đề tài \\ \hline
Tài liệu và hỗ trợ & Mức rõ ràng của documentation và khả năng xử lý sự cố \\ \hline
Data portability & Khả năng export dữ liệu, giảm vendor lock-in \\ \hline
...
\hline
\endhead
RPC provider & Kết nối Sepolia, đọc event & Provider qua RPC URL & Quota, giá, SLA, giới hạn request \\ \hline
IPFS pinning & Pin file, JSON, evidence & Pinata hoặc tương đương & Dung lượng, retention, redundancy \\ \hline
MongoDB & Notification, log, stats & MongoDB service & Storage, backup, giới hạn kết nối \\ \hline
Redis/Queue & Queue, retry, pub/sub & Redis service & Memory, persistence, failover \\ \hline
Backend hosting & Chạy API, worker, sidecar & VPS/cloud test & CPU/RAM, uptime, access policy \\ \hline
Frontend hosting & Static app, demo & Hosting phù hợp & Bandwidth, domain mapping, SSL \\ \hline
...
\hline
Hết free tier hoặc tăng giá & Làm lệch cost estimate và cần nâng gói đột xuất \\ \hline
Outage của nhà cung cấp & Ảnh hưởng môi trường test, demo hoặc UAT \\ \hline
Vendor lock-in & Khó export dữ liệu hoặc chuyển dịch vụ khi cần \\ \hline
Thay đổi API/chính sách & Tăng effort tích hợp và bảo trì \\ \hline
