...
\hline
\endhead
Test pass rate & $\geq$ 95\% trong bộ test hợp lệ & Phản ánh mức ổn định của deliverable trước khi chuyển gate \\ \hline
Coverage logic cốt lõi & $\geq$ 80\% statement coverage cho phần quan trọng & Bảo đảm các luồng tài chính và quyền truy cập được kiểm thử ở mức tối thiểu \\ \hline
Defect tồn đọng trước nghiệm thu & 0 Critical/High; Medium có owner; Low ghi backlog & Tạo ngưỡng chấp nhận rõ ràng trước UAT/bàn giao \\ \hline
API response time & Thông thường $\leq$ 2 giây ở môi trường thử nghiệm ổn định & Hạn chế trải nghiệm chậm gây hiểu nhầm trạng thái hệ thống \\ \hline
Thời gian hiển thị nội dung ban đầu & $\leq$ 3 giây với trang chính & Kiểm soát mức sẵn sàng trình diễn và sử dụng thử \\ \hline
Tính nhất quán trạng thái sự kiện & 100\% sự kiện trọng yếu có dữ liệu hiển thị tương ứng & Bảo đảm minh bạch giữa blockchain, backend và giao diện \\ \hline
...
\hline
Tỷ lệ task đạt Definition of Done & $\geq$ 90\% & Kiểm tra mức tuân thủ chuẩn hoàn thành \\ \hline
Review turnaround time & $\leq$ 24 giờ làm việc & Giảm tắc nghẽn và tránh tồn đọng PR \\ \hline
Build success rate & $\geq$ 95\% & Phản ánh độ ổn định của pipeline và cấu hình \\ \hline
Defect leakage & Giảm dần qua các milestone & Đo số lỗi lọt sang giai đoạn sau do kiểm soát chưa đủ sớm \\ \hline
Defect reopen rate & $\leq$ 10\% & Đánh giá chất lượng sửa lỗi và retest \\ \hline
...
\hline
\endhead
Phạm vi/yêu cầu & Use case, RTM, acceptance criteria và WBS nhất quán & Biên bản review, RTM, baseline được duyệt \\ \hline
Thiết kế & Kiến trúc, interface, dữ liệu và test approach đã rà soát & Tài liệu thiết kế, checklist review, quyết định kỹ thuật \\ \hline
Phát triển lõi & Luồng quan trọng có unit test và review chéo & PR review, test result, log build/lint \\ \hline
Tích hợp & Luồng end-to-end chạy ổn định, defect trọng yếu đã xử lý & Test report, defect log, demo nội bộ \\ \hline
UAT/triển khai & Không còn lỗi Critical/High, có runbook và bằng chứng UAT & UAT checklist, release note, deployment record \\ \hline
...
\hline
Critical & Gây mất chức năng cốt lõi, rủi ro quỹ, sai quyền hoặc chặn toàn bộ luồng chính & Có biện pháp cô lập/sửa trong 4 giờ làm việc \\ \hline
High & Ảnh hưởng nghiêm trọng đến một luồng nghiệp vụ trọng yếu nhưng còn workaround hạn chế & Xử lý trong 1 ngày làm việc \\ \hline
Medium & Ảnh hưởng một phần chức năng, chưa chặn toàn bộ luồng & Xử lý trong 3 ngày làm việc \\ \hline
...
\hline
UI validation & 4 & Form campaign/donation cho phép nhập thiếu hoặc sai định dạng & Bổ sung validation checklist trước demo \\ \hline
ABI/address mismatch & 3 & Frontend hoặc listener gọi sai contract address sau redeploy & Khóa address registry và cập nhật env template \\ \hline
Documentation gap & 3 & Runbook thiếu biến môi trường hoặc thiếu bước verify contract & Review tài liệu bằng checklist bàn giao \\ \hline
Access control & 2 & Role không đúng khi approve hoặc release fund & Thêm negative test và review quyền \\ \hline
