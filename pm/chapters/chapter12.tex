...
\midrule
Mã nguồn và release & Repository, tag cuối, commit tham chiếu, hướng dẫn build \\
Contract artifact & Source, ABI, address, verify link, network information \\
Triển khai và cấu hình & Deployment script, `.env.example`, runbook, smoke test steps \\
Backend/frontend & API doc, config cần thiết, hướng dẫn chạy môi trường demo \\
Chất lượng & Test report, quality checklist, known issues, limitation note \\
...
\midrule
Scope & Deliverable achieved & Có hoàn thành các đầu ra cốt lõi đã baseline hay không \\
Schedule & Milestone, SPI, độ lệch & Dự án có giữ được các mốc chính hay dùng nhiều buffer \\
Cost & CPI, CV, reserve used & Chi phí quy đổi có nằm trong khung cho phép hay không \\
Quality & Defect, UAT, acceptance & Mức ổn định và mức chấp nhận của deliverable \\
...
\midrule
Nguyễn Thành Long & Baseline chỉ hữu ích khi status, change và bằng chứng được tích hợp cùng một nhịp & Chốt data date hằng tuần và không phát hành final report trước acceptance record \\
Đỗ Nguyễn Phương Thảo & Yêu cầu và phản hồi stakeholder cần được chuyển ngay thành acceptance criteria có thể kiểm tra & Chuẩn bị RTM/UAT checklist trước demo và ghi owner cho mọi phản hồi \\
...
\midrule
Nghiệm thu & Đối chiếu RTM, test, UAT, biên bản chấp nhận \\
Bàn giao & Source, tài liệu, runbook, report, known issues \\
Hồ sơ quản trị & Archive baseline, log, lessons learned, final report \\
Nhà cung cấp và tài khoản & Backup dữ liệu, thu hồi key, xác nhận owner cuối \\
