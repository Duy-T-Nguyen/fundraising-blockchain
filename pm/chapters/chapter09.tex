...
\midrule
1 & Quản trị dự án và phạm vi \\
2 & Lịch biểu và nguồn lực \\
3 & Chi phí và reserve \\
4 & Blockchain và smart contract \\
5 & Backend, dữ liệu và hạ tầng \\
6 & Frontend và trải nghiệm người dùng \\
...
\midrule
\endhead
R01 & Scope creep sát hạn & 4 & 4 & 16 & PM/BA & Giữ baseline và kiểm soát thay đổi qua CCB \\
R02 & Thiếu key person ở module quan trọng & 3 & 4 & 12 & PM/TL & Review chéo, backup person, tài liệu hóa \\
R03 & Vulnerability trong contract & 3 & 5 & 15 & TL/BC & Test, review, checklist bảo mật, thư viện chuẩn \\
R04 & Deploy sai contract hoặc address & 3 & 4 & 12 & TL/DevOps & Checklist deploy, verify, smoke test \\
R05 & ABI hoặc config không đồng bộ & 4 & 4 & 16 & TL/FE/BE & Versioning, integration gate, config audit \\
R06 & Secret bị lộ & 2 & 5 & 10 & DevOps/PM & Không commit secret, rotate key, kiểm tra quyền truy cập \\
R07 & Gas tăng hoặc redeploy nhiều lần & 3 & 3 & 9 & PM/TL & Reserve, tối ưu số lần deploy, theo dõi usage \\
R08 & IPFS/RPC gián đoạn & 3 & 4 & 12 & BE/DevOps & Fallback, retry, alternate provider, status notice \\
R09 & Test không đủ, defect lọt sang UAT & 4 & 4 & 16 & QA/PM & RTM, negative test, E2E, quality gate rõ ràng \\
...
\midrule
Redeploy contract nhiều lần & 30\% & 1.000.000 VNĐ & 300.000 VNĐ \\
Vượt free tier hạ tầng & 25\% & 1.200.000 VNĐ & 300.000 VNĐ \\
...
\midrule
R01 & Scope creep sát hạn & Yêu cầu mới ảnh hưởng WBS/milestone & Chặn thay đổi ngoài baseline, phân tích tác động và đưa qua CCB \\
R03 & Vulnerability trong contract & Review/test phát hiện logic nhạy cảm & Tăng review chéo, thêm test và không qua gate nếu chưa đóng issue \\
R05 & ABI hoặc config không đồng bộ & Có thay đổi contract/deploy & Kích hoạt integration gate, cập nhật config và test lại E2E \\
...
\midrule
Xanh & Không có rủi ro High/Critical mới, trigger trong kiểm soát & Theo dõi định kỳ \\
Vàng & Có rủi ro High mới hoặc residual risk tăng & PM rà lại response và reserve \\
