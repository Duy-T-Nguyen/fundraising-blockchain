...
Tên sản phẩm & FundChain \\
Loại sản phẩm & Ứng dụng web phi tập trung quản lý gây quỹ \\
Đơn vị thực hiện & Nhóm 2 \\
Thời gian baseline & 01/04/2026--30/06/2026 \\
Môi trường blockchain & Ethereum Sepolia Testnet \\
Thành phần chính & React DApp, NestJS backend, Solidity smart contract, AI sidecar \\
Kho dữ liệu & Sepolia, IPFS/Pinata, MongoDB và Redis \\
...
\midrule
\endhead
OBJ-01 & Tỷ lệ yêu cầu bắt buộc vượt UAT & 100\% yêu cầu Must Have \\
OBJ-02 & Kiểm thử logic smart contract cốt lõi & Tối thiểu 80\% statement coverage \\
OBJ-03 & Lỗi trước nghiệm thu & Không còn lỗi Critical hoặc High \\
OBJ-04 & Luồng end-to-end & Chạy được từ tạo chiến dịch đến giải ngân trên Sepolia \\
OBJ-05 & Khả năng truy vết & Có transaction hash, event và CID tương ứng \\
OBJ-06 & Hiệu năng API thông thường & Không quá 2 giây trong môi trường thử nghiệm ổn định \\
OBJ-07 & Hiển thị nội dung trang chính & Không quá 3 giây trong điều kiện thử nghiệm \\
OBJ-08 & Tiến độ & Hoàn thành trước hoặc trong ngày 30/06/2026 \\
OBJ-09 & Ngân sách & EAC không vượt Project Budget 64 triệu VNĐ \\
...
\midrule
Blockchain & Quản lý chiến dịch, quỹ, yêu cầu chi và phân quyền & Bảo mật, gas, test, thay đổi interface và triển khai \\
Backend/IPFS & Metadata, bằng chứng, đồng bộ event và thông báo & API, dữ liệu, dịch vụ ngoài, tính sẵn sàng và bảo mật secret \\
Relayer/AI & Hàng đợi giao dịch và hỗ trợ tối ưu thời điểm gửi & Chi phí vận hành, fallback, monitoring và giới hạn phạm vi AI \\
Frontend & Trang công khai và dashboard theo vai trò & Yêu cầu người dùng, UI/UX, tích hợp và UAT \\
Hạ tầng & Sepolia, RPC, MongoDB, Redis, Pinata và hosting & Mua sắm, quota, SLA, configuration và phương án dự phòng \\
...
\midrule
\endhead
Donor & Minh bạch và bảo vệ khoản đóng góp & Donate, theo dõi lịch sử, vote, validator approval, nhận notification và claim refund \\
Campaign Manager & Tổ chức và điều phối chiến dịch & Submit proposal, tạo/hủy request, theo dõi quỹ, finalize và deactivate campaign \\
Platform Admin & Kiểm soát nền tảng & Duyệt/từ chối campaign, quản lý Supplier, phí chống spam và quyền admin \\
Supplier & Nộp bằng chứng và nhận thanh toán & Quản lý hồ sơ, xem nhiệm vụ, submit proof và theo dõi earnings \\
...
\midrule
Quyền lực cao, quan tâm cao & Giảng viên/người nghiệm thu, PM, Platform Admin & Quản lý chặt, báo cáo định kỳ, tham gia quyết định baseline/change \\
Quyền lực thấp hơn, quan tâm cao & Donor, Manager, Supplier, Verifier, nhóm phát triển & Cập nhật thường xuyên, demo và lấy phản hồi \\
Quyền lực cao, quan tâm thấp & Nhà cung cấp hạ tầng chủ chốt & Theo dõi SLA, quota, thay đổi dịch vụ và phương án dự phòng \\
...
\begin{landscape}
\begin{longtable}{p{3.2cm}ccccc p{5.8cm}p{2.5cm}p{2.5cm}}
...
\midrule
\endhead
Giảng viên/người nghiệm thu & & & & C & D & Gửi status trước milestone, demo bằng tiêu chí nghiệm thu và chốt decision log & PM & Mỗi milestone \\
Nhóm 2/PM & & & & C & D & Duy trì baseline, weekly review và chủ động escalation blocker & PM & Hằng tuần \\
Đội kỹ thuật & & & C & D & & Workshop yêu cầu, công bố Definition of Done, review chéo và retrospective & TL/PM & Mỗi sprint \\
Platform Admin & & & C & D & & Demo quyền quản trị, security checklist và UAT luồng duyệt chiến dịch & BA & Sprint 3--6 \\
Donor & C & & & D & & Prototype, usability test và UAT donate/vote/refund & BA/FE & Sprint review \\
Campaign Manager & & & C & D & & Phỏng vấn yêu cầu và UAT tạo campaign/request/finalize & BA & Sprint 2, 5--6 \\
Supplier & C & & & D & & Hướng dẫn proof CID, demo submit proof và lấy phản hồi & BA/QA & Sprint 4--6 \\
Verifier & & & C & D & & Walkthrough quy tắc verify/reject và UAT bằng dữ liệu mẫu & BA/QA & Sprint 4--6 \\
...
\midrule
\endhead
D1 & Bộ tài liệu phân tích/thiết kế & Requirement, RTM, use case, architecture & Review và baseline được duyệt \\
D2 & Blockchain module & Contracts, ABI, scripts và tests & Test report, tx hash, verified source \\
D3 & Backend/AI & Evidence, listener, notification, relayer, sidecar & API test, log và demo tích hợp \\
D4 & Frontend DApp & Public pages và role dashboards & Build thành công và UAT \\
D5 & Hạ tầng/cấu hình & Docker, env template, MongoDB, Redis & Deployment checklist và smoke test \\
D6 & Báo cáo chất lượng & Test plan, result, defect và security checklist & Không còn Critical/High defect \\
D7 & Tài liệu sử dụng/vận hành & README, deploy guide, demo script & Người nhận có thể tái triển khai \\
