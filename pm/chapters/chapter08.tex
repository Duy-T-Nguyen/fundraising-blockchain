...
\midrule
\endhead
Daily sync & Tiến độ, blocker, effort còn lại & Thành viên & Nhóm dự án & Hằng ngày & Chat/board & Action list ngắn \\
Weekly status & Scope, schedule, cost, risk, chất lượng & PM & Nhóm 2, stakeholder chính & Hằng tuần & Report/meeting & Status report \\
Sprint planning & Backlog, capacity, ưu tiên & PM/BA & Dev, QA, nhóm liên quan & Mỗi sprint & Meeting/board & Sprint backlog \\
Sprint review & Demo, phản hồi, acceptance sơ bộ & Nhóm dự án & Stakeholder liên quan & Mỗi sprint & Demo/meeting & Accepted hoặc rework \\
Technical review & API, ABI, design, integration impact & Technical Lead & Dev, QA, PM & Khi có thay đổi & PR/doc/meeting & Decision record \\
Incident alert & Lỗi Critical, deploy sai, outage, secret risk & Người phát hiện & PM, TL, nhóm liên quan & Ngay lập tức & Alert/call/chat & Incident record \\
...
\midrule
Tổng quan kỳ báo cáo & Mốc thời gian, người lập, trạng thái tổng thể \\
RAG dashboard & Scope, Schedule, Cost, Quality, Risk \\
Hoàn thành chính & Deliverable, milestone hoặc decision đã đạt \\
Kế hoạch tiếp theo & Task trọng tâm và owner \\
Blocker/Issue & Mô tả, tác động, người xử lý, hạn hoàn thành \\
Thay đổi & Change request đã duyệt hoặc đang chờ xem xét \\
...
\midrule
Xanh & Action item và phản hồi trong ngưỡng chấp nhận & Duy trì cơ chế hiện tại \\
Vàng & Nhiều action item trễ hoặc hiểu sai yêu cầu lặp lại & PM rà lại tần suất, biểu mẫu và owner \\
