...
\hline
Scope & Major change = 0 & Xanh & Yêu cầu KYC được ghi backlog, chưa đưa vào release ba tháng & Giữ Scope Baseline, chỉ nhận change qua CCB \\ \hline
Schedule & SPI = 0,933 & Vàng & Integration gate chậm do sửa contract và đồng bộ ABI/address & Ưu tiên activity đường găng, dùng crash option đã phân tích \\ \hline
Cost & CPI = 0,955 & Vàng nhẹ & Effort tăng vì rework nhưng chưa vượt ngưỡng đỏ & Theo dõi AC tuần kế và không dùng reserve nếu chưa có trigger \\ \hline
Quality & 0 Critical/High & Vàng & Còn lỗi Medium về validation, tài liệu và tích hợp & Regression test, UAT checklist và defect triage hằng ngày \\ \hline
Risk & R03/R09 tăng & Vàng & Rủi ro redeploy và defect lọt sang UAT cao hơn baseline & Kích hoạt response plan, cập nhật risk owner \\ \hline
...
\hline
Giá trị nghiệp vụ & Thay đổi có thực sự cần thiết với mục tiêu dự án không? \\ \hline
Phạm vi & Có làm thay đổi deliverable hoặc WBS đã baseline không? \\ \hline
Lịch biểu & Có ảnh hưởng activity đường găng, milestone hoặc buffer không? \\ \hline
Chi phí & Có làm tăng effort, reserve hoặc Project Budget không? \\ \hline
Chất lượng & Có đòi hỏi thêm test, review hoặc quality gate mới không? \\ \hline
Rủi ro & Có tạo rủi ro mới hoặc làm tăng residual risk không? \\ \hline
Tích hợp kỹ thuật & Có ảnh hưởng contract storage, ABI, API, config hoặc deployment không? \\ \hline
...
\hline
Source code & Version, branch, release tag và review history \\ \hline
ABI và contract artifact & Đồng bộ với contract version và frontend/backend integration \\ \hline
Deployment record & Network, address, verify link, thời điểm deploy và owner \\ \hline
Environment configuration & Template rõ ràng, không chứa secret thật \\ \hline
Docker/config runtime & Theo dõi image, service và biến môi trường liên quan \\ \hline
...
\hline
\endhead
Contract source & Git commit, tag, compiler, optimizer, constructor args & Review chéo; test và static analysis đạt ngưỡng & BC/TL & Commit, PR, test report \\ \hline
ABI/artifact & Contract version, checksum, generated-at commit & Không sửa tay; CI so checksum với artifact & BC & Artifact bundle \\ \hline
Deployment record & Network, chain ID, address, deployer, tx hash, block, thời điểm & Receipt thành công; source verified; smoke test đạt & DevOps/TL & Manifest, explorer link \\ \hline
Application config & ABI version, address, RPC alias, feature flags & Frontend/backend cùng manifest; integration test đạt & BE/FE & Build log, test report \\ \hline
Secret/credential & Tên secret, mục đích, custodian, scope, ngày rotate & Không xuất hiện trong source/log/artifact; least privilege & DevOps/PM & Secret-scan log, access record \\ \hline
