...
\midrule
Minh bạch và khả năng kiểm toán & 25\% & Đo mức độ người dùng và stakeholder có thể tự kiểm chứng trạng thái quỹ, quyết định chi và lịch sử thay đổi \\
Bảo mật và kiểm soát tài sản & 20\% & Đánh giá khả năng hạn chế giải ngân tùy ý, sai phân quyền và rủi ro thao tác với tiền/quỹ \\
Chi phí đầu tư và vận hành & 15\% & Xem xét tổng chi phí nhân lực, hạ tầng, giao dịch và độ nhạy với biến động vận hành \\
Trải nghiệm người dùng & 15\% & Đo khả năng tiếp cận đối với người dùng không chuyên, số bước thao tác và rào cản tham gia \\
Khả năng mở rộng và tích hợp & 10\% & Đánh giá mức độ dễ mở rộng chức năng, tích hợp dịch vụ và đáp ứng nhu cầu phát triển về sau \\
Đơn giản triển khai và bảo trì & 10\% & Đánh giá độ phức tạp của kiến trúc, số lượng dependency và effort bảo trì \\
...
Bảo mật/kiểm soát tài sản & 20\% & 3 & 4 & 4 \\
Chi phí đầu tư/vận hành & 15\% & 4 & 3 & 3 \\
Trải nghiệm người dùng & 15\% & 5 & 2 & 4 \\
Khả năng mở rộng/tích hợp & 10\% & 4 & 3 & 4 \\
...
\begin{tabularx}{\textwidth}{>{\bfseries}p{4.2cm}cccX}
\toprule
Kịch bản & Web2 & DApp & PA3 & Thứ hạng \\
\midrule
Baseline: Chi phí 15\%, UX 15\% & 3,450 & 3,600 & 3,950 & PA3 $>$ PA2 $>$ PA1 \\
Chi phí tăng lên 30\% & 3,547 & 3,494 & 3,782 & PA3 $>$ PA1 $>$ PA2 \\
...
\midrule
Strategic fit & Phương án phải phục vụ minh bạch dòng tiền, kiểm soát giải ngân và khả năng truy vết công khai & Phù hợp cao \\
Financial fit & Tổng ngân sách quy đổi không vượt 64 triệu VNĐ; NPV giả định dương; chi phí phát sinh có reserve & Chấp nhận được \\
Technical fit & Source code thực tế đã có blockchain, backend, frontend, IPFS, relayer và AI sidecar & Bám sát hiện trạng \\
Schedule fit & Có thể triển khai trong ba tháng nếu khóa interface sớm, kiểm soát đường găng và dùng buffer hợp lý & Khả thi có điều kiện \\
Risk fit & Rủi ro ABI, RPC, IPFS, redeploy và integration được đưa vào Risk Register và quality gate & Kiểm soát được \\
